                  ...
                  if (!empty($pagedData)): 
                    ?> 
                      ...
                      <tr>
                        ...
                        <td class="p-2 text-center align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                          <a href="index.php?page=products&action=edit&id=<?= $item['id'] ?>" class="inline-block mr-4 text-xs font-bold leading-tight text-blue-800 hover:text-blue-950"><i class="fas fa-edit mr-1"></i>Edit</a>
                          <a href="index.php?page=products&action=delete&id=<?= $item['id'] ?>" class="inline-block text-xs font-bold leading-tight text-red-500 hover:text-red-700" onclick="return confirm('Hapus produk?')"><i class="fas fa-trash mr-1"></i>Hapus</a>
                        </td>
                      </tr>
                      <?php endforeach; ?>
                  <?php else: ?>
