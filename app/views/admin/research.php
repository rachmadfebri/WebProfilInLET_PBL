                      ...
                      <tr>
                        ...
                        <td class="p-2 text-center align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                          <span class="text-xs font-semibold leading-tight text-slate-400">
                            <?= htmlspecialchars($research['uploader_name'] ?? 'Unknown') ?>
                          </span>
                        </td>
                        ...
                        <td class="p-2 text-center align-middle bg-transparent whitespace-nowrap shadow-transparent">
                          <a href="index.php?page=research&action=edit&id=<?= $research['id'] ?>" class="text-xs font-bold leading-tight text-blue-800 mr-6 hover:text-blue-950 transition-all"><i class="fas fa-edit mr-1"></i>Edit</a>
                          <a href="index.php?page=research&action=delete&id=<?= $research['id'] ?>" class="text-xs font-bold leading-tight text-red-500 hover:text-red-700 transition-all" onclick="return confirm('Yakin ingin menghapus riset ini?')"><i class="fas fa-trash mr-1"></i>Hapus</a>
                        </td>
                      </tr>
                      <?php endforeach; ?>
                  <?php else: ?>
